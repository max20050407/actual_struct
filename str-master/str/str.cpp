...
int c1() {
	...
	{getline(dialog, line); cout << line;
	 ...
	 getline(dialog, line); cout << line;
	 getline(cin, new1.city);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.games);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.loose);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.win);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.draw);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.players);
	 getline(dialog, line); cout << line;
	 getline(cin, new1.tran); }
	//Вывод данных в файл
	...
	if (param == 1) {
		for (int i = 0; i < cs; i++) {
			if (All[i].name == serch)
			{
				...
				cout << "Количество сыгранных игр : " << All[i].games << endl;
				cout << "Количество поражений     : " << All[i].loose << endl;
				cout << "Количество побед         : " << All[i].win << endl;
				cout << "Количество ничей         : " << All[i].draw << endl;
				cout << "Количество футболистов   : " << All[i].players << endl;
